...
交付检查：run/index/report 一致、七个 section、每源目标/上限、brief/精选事件关系、发布时间（缺失时显示采集时间）与 NEW、URL/标题身份、正文访问等级、研判精选事件引用、JSON/Markdown/HTML/PDF、`reports/index.html`、待验证链接及可选 Notion page ID。
